...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self):
    ...
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 1599.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 699.
    self._DISTRACTED_TIME = 8811. # active monitoring total timeout
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 899.
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 699.
